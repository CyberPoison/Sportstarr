    ...
    public static class ConsoleApp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            catch (SocketException ex)
            {
                System.Console.WriteLine("");
                System.Console.WriteLine("");
                Logger.Fatal(ex.Message + ". This can happen if another instance of Sportstarr is already running another application is using the same port (default: 5656) or the user has insufficient permissions");
